...
var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return function (dispatch) {
    APIUtil.fetchSearchGiphys(searchTerm).then(function (res) {
...
function GiphysIndex(_ref) {
  var giyphs = _ref.giyphs;

  console.log(giyphs);
  return _react2.default.createElement(
    'ul',
    null,
    giyphs.map(function (gif) {
      return _react2.default.createElement(_giphys_index_item2.default, { gif: gif });
    })
  );
}
...
var GiphySearch = function (_React$Component) {
  ...
  _createClass(GiphySearch, [{
    ...
    value: function handleClick(e) {
      ...
      var fetchGiphys = this.props.fetchGiphys;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_giphys_index2.default, { giyphs: this.props.giphys })
      );
    }
  }]);
...
var giphySearchContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_giphys_search2.default);

exports.default = giphySearchContainer;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(59), __webpack_require__(218)(module)))
